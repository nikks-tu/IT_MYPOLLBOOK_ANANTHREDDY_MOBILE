...
public interface Constants {
    //Test Base URL Nikita
    String LIVE_BASE_URL = "http://182.18.177.27:78/mypbCKAR/";
    //Production Base URL
    //String LIVE_BASE_URL = "https://mypollbook.com/kar/";
    String GET_ANNOUNCEMENT = LIVE_BASE_URL+"api/v1/announcements";
    String SEARCH_ANNOUNCEMENT = LIVE_BASE_URL+"api/v1/searchAnnouncement";
    String UPDATE_LIKE = LIVE_BASE_URL+"api/v1/announcementLike";
    String PARTICIPATE_ANNOUNCEMENT = LIVE_BASE_URL+"api/v1/announcementParticipate";
    String ANNOUNCEMNET_LIKES = LIVE_BASE_URL+"api/v1/getAnnouncementLikes";
    String ANNOUNCEMNET_COMMENTS = LIVE_BASE_URL+"api/v1/getAnnouncementComments";
    String SUBMIT_COMMENTS = LIVE_BASE_URL+"api/v1/announcementComment";
    String DILETE_COMMENTS = LIVE_BASE_URL+"api/v1/deleteAnnouncementComments";
    ...
    //terms and condition
    String TERMS_AND_CONDITION_ACTION = "com.contus.activity.TermsAnd   Condition";
    //register
    ...
    //Search poll poll id  answer selcted size
    ...
    //Search poll poll id  answer selcted array
   ...
   String MOBILE_EXIST = "mobilenoexist";
   String FCM_REG_ID = "FCM_REG_ID";
   String APP_VERSION_CHECK = "api/v1/version";
   String GET_USER_COMPLAINTS = "api/v1/complaintlist";
   String SIGNUP_NEW_USER = "api/v1/sign_up";
    /**
    ...
    String FRAGMENT_From = "FRAGMENT_From";
    String FromEditProfile = "FromEditProfile";
}
